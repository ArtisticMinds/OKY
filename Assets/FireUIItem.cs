...
public class FireUIItem : MonoBehaviour
{
    ...
    int seconds;
    string stringTime;
    public static FireUIItem Instance;
    ...
    void EndTime()
    {
        GameManager.m_Character.ShotIsActive = false;
        GameUI.Instance.FireButton.SetActive(false);
