...
public class FireShot3DItem : MonoBehaviour
{

    public ItemType itemType = ItemType.FireShot;
    ...
    public void Delete()
    {
        ...
        GameObject.Instantiate(ParticleOnDestroy, transform.position, transform.rotation); //Effetto Distruzione
